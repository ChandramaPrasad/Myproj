package com.domain.framework.net;
	...
	public byte[] execute() {
		try {
			...
			if (exception instanceof SocketTimeoutException) {
				...
				// we will make it
				if (exception.getMessage()== null || !exception.getMessage().startsWith("{")) {

					return covertErrorStringInJsonForm(exception.toString() + ""+exception.getMessage())
							.getBytes();
				}
